...
if __name__ == "__main__":
    ...
    # Figure 1: x-axis = model parameters
    draw_combined_societal_scatter_panels(
        ...
        output_basename="societal_parameter_vs_delta_GenderIdentity_SexualOrientation_combined_nature_style",
    )

    # Figure 2: x-axis = effective training compute
    draw_combined_societal_scatter_panels(
        attribute_type_to_application_to_model_to_delta=attribute_type_to_application_to_model_to_delta,
        ...
        output_basename="societal_training_compute_vs_delta_GenderIdentity_SexualOrientation_combined_nature_style",
    )