...
def draw_results_grid_big(attribute_type, resume_counts, model_names, pool_count, max_n_trials):
    ...
    for idx, model_name in enumerate(model_names):
        ...
        sample_path = f"outputs/loan/contextual/{attribute_type}/{model_name}_{resume_counts[0]}_{pool_count}.jsonl"
    ...
    save_file = f"outputs/loan/mixed_grid_{attribute_type}.png"
