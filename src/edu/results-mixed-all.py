...
def plot_model_panel(ax, attribute_type, resume_counts, model_name, pool_count, max_n_trials):
    ...
    for rc in resume_counts:
        file_path = f"outputs/edu/contextual/{attribute_type}/{model_name}_{rc}_{pool_count}.jsonl"
...
def draw_results_grid_big(attribute_type, resume_counts, model_names, pool_count, max_n_trials):
    ...
    for idx, model_name in enumerate(model_names):
        ...
        sample_path = f"outputs/edu/contextual/{attribute_type}/{model_name}_{resume_counts[0]}_{pool_count}.jsonl"
    ...
    save_file = f"outputs/edu/mixed_grid_{attribute_type}.png"
