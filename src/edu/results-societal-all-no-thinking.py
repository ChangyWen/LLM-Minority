...
def plot_model_panel_societal(
    ...
    model_clean = model_clean.replace("_no_thinking", "")
    ax_main.set_title(model_clean + subfix_text, fontweight="bold")
...
def draw_results_grid_societal(attribute_types, model_names):
    ...
    fig.suptitle("EDU - Societal Minority vs Majority Scores", fontweight="bold", y=0.97)
    ...
    # Save one big figure
    save_file = "outputs/edu/societal_grid_no_thinking.png"
