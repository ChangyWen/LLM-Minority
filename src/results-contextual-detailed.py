...
def compute_results(file_name, attribute_type, pool_count, anchor_idx_to_resume_idx):
    total_count = 0
        ...
        for resume_count in [5]:
            for model_name in ["msra-gpt-4o", "msra-gpt-4.1-nano"]:
                ...
                if os.path.exists(file_name):
                    print(f"------------------------------------\n\n{file_name}")
                    results = compute_results(file_name, attribute_type, pool_count, anchor_idx_to_resume_idx)
