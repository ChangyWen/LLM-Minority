...
def draw_results_grid(attribute_type, resume_count, model_names, pool_count, max_n_trials):
    ...
    for idx, model_name in enumerate(model_names):
        ...
        if "no_thinking" in model_name:
            file_name = f"outputs/hiring/contextual/{attribute_type}/{model_name[:-12]}_{resume_count}_{pool_count}_no_thinking.jsonl"
        else:
    ...
    # Save one big figure
    save_file = f"outputs/hiring/contextual_grid_{attribute_type}_{resume_count}_no_thinking.png"
