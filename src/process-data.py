...
2. Identify the job title(s) listed at the very beginning of the resume. These may include one or multiple professional titles (e.g., "HR DIRECTOR", "FINANCE OFFICE ASSOCIATE", "LICENSED UNITED HEALTHCARE INSURANCE SALES AGENT").
3. Extract these job titles verbatim, without modifying capitalization, punctuation, or spacing.
4. If one or more job titles are found, output them inside <job-titles> and </job-titles> tags at the end of your response.
5. If no such job titles appear at the beginning of the resume, respond with: No job titles found.
""".strip()
